...
namespace TaskManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260621174340_CreateWorkItemDateTable")]
    partial class CreateWorkItemDateTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManagement.Domain.WorkItemDates.WorkItemDate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("WorkItemDates", (string)null);
                });
            ...
            modelBuilder.Entity("TaskManagement.Domain.WorkItemDates.WorkItemDate", b =>
                {
                    b.HasOne("TaskManagement.Domain.WorkItems.WorkItem", "WorkItem")
                        .WithOne("WorkItemDate")
                        .HasForeignKey("TaskManagement.Domain.WorkItemDates.WorkItemDate", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
